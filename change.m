...
% CHANGE MATLAB code for change.fig
...
%      function named CALLBACK in CHANGE.M with the given input arguments.
%
%      CHANGE('Property','Value',...) creates a new CHANGE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before change_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 26-Nov-2017 16:32:46
...
global userInput1
userInput1 = get(handles.edit1,'string');
assignin('base','userInput1',userInput1);
...
global userInput1
if userInput1==get(handles.edit2,'String')
 save('pass.mat','userInput1','-append')
